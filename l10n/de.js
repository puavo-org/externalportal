OC.L10N.register(
    ...
    "Use theme color" : "Designfarbe verwenden",
    ...
    "Limit icon size" : "Symbolgröße begrenzen",
    "Limit each icon to 64x64px to prevent small pixmap icons from being stretched" : "Jedes Symbol auf 64x64px begrenzen, damit kleine Pixmap-Symbole nicht gestreckt werden",
    "Show Files link" : "Dateien-Link anzeigen",
    "Add a shortcut to the Files app as the first item in the widget" : "Eine Verknüpfung zur Dateien-App als erstes Element im Widget hinzufügen",
    "Icon colors" : "Symbolfarben",
    "Custom icon color" : "Benutzerdefinierte Symbolfarbe",
    "Preview" : "Vorschau",
    "Color" : "Farbe",
    "Loading …" : "Wird geladen …",
    "Could not load external sites." : "Externe Seiten konnten nicht geladen werden.",
